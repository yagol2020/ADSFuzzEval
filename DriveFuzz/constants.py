...
MSG_EMPTY_FRICTION_ARG = (
    "--friction should be followed by level, size " "and location coordinate."
)
MSG_BAD_FRICTION_ARG = "Number of friction args has to be 7."
MSG_BAD_FRICTION_LEVEL = "Friction level should be in range [0.0-1.0]."
MSG_EMPTY_ACTOR_ARG = (
    "--actor should be followed by actor_type, and " "corresponding values."
)
MSG_BAD_ACTOR_TYPE = "--actor expects 0, 1, or 2 as actor_type."
MSG_BAD_ACTOR_ATTR = (
    "Vehicle or walker requires 12 args: "
